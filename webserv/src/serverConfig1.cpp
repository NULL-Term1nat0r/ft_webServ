...
void serverConf::constructFileTypeContainer(){
	...
	fileTypeContainer["txt"] = "text/html";
...
void serverConf::constructStatusMessageContainer(){
	statusMessageContainer[200] = "OK";
	statusMessageContainer[201] = "Created";
	statusMessageContainer[301] = "Moved Permanently";
	statusMessageContainer[400] = "Bad Request";
	statusMessageContainer[404] = "Not Found";
	statusMessageContainer[403] = "Forbidden";
	statusMessageContainer[405] = "Method Not Allowed";
	statusMessageContainer[415] = "Unsupported Media Type";
	statusMessageContainer[413] = "Payload Too Large";
	statusMessageContainer[500] = "Internal Server Error";
	statusMessageContainer[504] = "Gateway Timeout";
}
...
std::string serverConf::getErrorMessage(int errorCode) {
	std::string errorMessage = statusMessageContainer[errorCode];
	if (errorMessage.empty())
		return "Internal Server Error";
	return statusMessageContainer[errorCode];
}
...
void	serverConf::_indexFileNotExisting() {
	std::string file;
	int			fileDescriptor;
	for (int i = 0; i < (int)_server.size(); i++) {
